    ...
    <main role="main"> 
        ...
        <div class="row p-0">
            <div class="col-md-8" id="darkblue-section">
              <div>
                <h2 class="header-gold"> hier gaan we aan werken!</h2>
                <br>
            ...
            <div class="row p-0">
              <div class="col-md-8 text-center" id="darkblue-section-text">
                  ...
                  <p>Paarden leven in een groep en hebben daarbinnen hun eigen plek. Er zijn altijd leiders aanwezig. Wie de kudde aanvoert is voor iedereen duidelijk. Het paard is een prooidier en vanuit zijn natuur weet hij dat hij afhankelijk van de ander is om te overleven. Om te overleven zijn zij meesters in de non-verbale communicatie. Zelfs de kleinste verandering in je lichaam (denk aan ademhaling, spierspanning, kloppen van het hart etc.) herkennen paarden en kunnen hierop reageren. Dat maakt paarden heel sterk in hun (non) verbale communicatie. Paarden zijn ook eerlijk in hun communicatie. Er heerst in de kudde geen jaloezie of onzekerheid. Ze vormen geen oordeel. Ze zijn altijd zichzelf: zonder oordeel en vol overgave trouw aan de rest. 
                    ...
                    .Paarden geven je feedback over hoe je (non-verbaal) communiceert. Deze pure feedback helpt ons om meer bewust te worden van de effecten van ons gedrag, gedachten en gevoel. Door het ervaringsgericht werken met de paarden kunnen de opgedane inzichten direct vertaald worden naar de dagelijkse praktijk.</p>
              </div>
              <div class="col-md-4 m-0 p-0" style="background-image: url('images/wiebenik.jpg');"> </div>
  
              </div>
              <div class="text-center p-3 m-4">
                <div class="row">
                    <div class="col-lg-6 m-auto ">
                    <h2 class="subheader-orange">team coaching</h2>
                    <p>Bij teamsessies ligt de focus meer op de groep. Teams kunnen in een sessie van een dagdeel veel inzicht krijgen in de wijze waarin zij samenwerken. En wat is de inbreng van de verschillende teamleden in een team...
                      ...
                      Samen met de paarden geeft dit snel inzicht in het functioneren van een team. Er ontstaat helderheid over rollen binnen een team. De oefeningen in de groepssessie worden afgestemd op het leerdoel en de vooraf afgesproken wensen.
